  ...
  return (
   <div
    ...
    >
      ...
      {/* Chat Panel */}
      <main className="w-full px-0 py-0 min-h-0">
         <Card className="relative h-full flex flex-col overflow-hidden border border-white/10 bg-white/10 rounded-none shadow-none">
          <CardContent className="p-0 flex-1 min-h-0">
            <ScrollArea className="h-full overflow-x-hidden">

              <div
                className="p-1 space-y-0"
                ref={(el) => {
                  if (!el) return;
                  setTimeout(() => {
      ...
      {/* Composer */}
      <footer className="border-t border-white/10 bg-slate-900/50 backdrop-blur supports-[backdrop-filter]:bg-slate-900/50 mt-0 mb-0 p-0">

        <div className="w-full px-0 py-2">
          <div className="w-full rounded-none border border-white/10 bg-white/5 p-2 shadow-none flex items-end gap-2">
            ...
            <Button
              onClick={handleSend}
              className="px-5 py-2.5 font-medium bg-gradient-to-br from-fuchsia-500 to-indigo-600 text-white hover:from-fuchsia-400 hover:to-indigo-500 shadow-lg shadow-indigo-900/30"
            >
              Send
            </Button>
          </div>
