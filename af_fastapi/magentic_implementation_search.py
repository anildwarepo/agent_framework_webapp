...
class MagenticWorkflow():
    ...
    async def _ensure_clients(self):
        ...
        if self._weather_agent is None or self._workflow is None:
            self._weather_agent = ChatAgent(
                name="weather agent",
                description="Weather agent that can answer questions about the weather using a weather tool.",
                instructions="You are a helpful weather agent. Use the weather tool to answer questions about the weather.",
            ...
            self._workflow = (
                MagenticBuilder()
                .participants(weather=self._weather_agent)
